...
export default class Reference extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`https://alert-backend-ze8j.onrender.com/api/v1/health_alert/employee/${lastSegment}/health_measurement`)
            .then(res => res.json())
            .then(
                result => {
                    console.log(result); // Выводим результат в консоль для проверки
                ...
                <Container>
                    ...
                    <br/>
                            ...
                            >
                                ...
                                <Card.Body>
                                    <Card.Title>
                                        Температура: {items2.temperature}℃ <br/> <br/>
                                        Систолическое давление: {items2.systolic_pressure} мм рт. ст.<br/> <br/>
                                        Диастолическое давление: {items2.diastolic_pressure} мм рт. ст.<br/> <br/>
                                        Пульс: {items2.pulse} ударов в минуту<br/> <br/>
                                        Уровень стресса: {items2.stress_level}% <br/> <br/>
                                        Уровень кислорода в крови: {items2.oxygen_level}% <br/> <br/>
                                        Количество шагов: {items2.steps} шагов <br/> <br/>
                                        Координаты: {items2.latitude}, {items2.longitude} <br/> <br/>
                                    ...
                                    <div
                                        ...
                                        >
                                    <Button style={{ backgroundColor: 'grey', borderColor: 'black', color: 'white' }} href={`/employer/${items2.employee}`}>Текущие значения</Button>
                                    <Button variant="primary" style={{ borderColor: 'black'}} href={`/reference/${items2.employee}`}>Эталонные значения</Button>
                                    </div> <br/>
                                    <div
                                        style={{
                                            borderRadius: '8px',
